...
public class manageEmployee extends javax.swing.JFrame {
    ...
    public manageEmployee(String a,String b,String c){
        initComponents();
        la=a;
        lb=b;
        lc=c;
    ...
    private void refresh1(){
        ...
        try
        {
            ...
            ResultSet rs;
            rs = st.executeQuery("select * from employees where name ='"+a+"'");
            while(rs.next())
            {
    ...
    private void reorder(){;
        try{
            ...
            int s=stmt.executeUpdate("ALTER TABLE employees DROP `id`;");
            int t=stmt.executeUpdate("ALTER TABLE employees AUTO_INCREMENT =1;");
            int u=stmt.executeUpdate("ALTER TABLE employees ADD `id` int UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST;");
    ...
    private void refresh(){
        try
        {
            ...
            while(rs.next())
            {
                Object o[]={rs.getInt("id"),rs.getString("name"),rs.getString("employeeid"),rs.getString("category"),rs.getString("number")};
                tm.addRow(o);
            }
            reorder();
        }
    ...
    private void initComponents() {
        ...
        productTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr.no", "Employee Name", "Employee ID", "Employee Category", "Mobile No."
            }
        ) {
        ...
        category.setBounds(220, 290, 220, 40);

        number.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jPanel1.add(number);
        number.setBounds(220, 340, 220, 40);
        ...
        jPanel1.add(search);
        search.setBounds(290, 500, 120, 30);
        ...
        jPanel1.add(update);
        update.setBounds(290, 500, 120, 30);

        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/7.png"))); // NOI18N
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        String d = number.getText();
        if(!(a.equals("")||b.equals("")||c.equals("")||d.equals(""))){
            try{
                Class.forName("java.sql.Driver");
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost/inventorymanager","root","nikhil");
                Statement stmt = con.createStatement();
                int s = stmt.executeUpdate("insert into employees (name,employeeid,category,number) values ('"+a+"','"+b+"','"+c+"','"+d+"');");
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        if(!(name.getText().equals(""))){
            ...
            if(!(a.equals("")||b.equals("")||c.equals("")||d.equals(""))){  
                ...
                JOptionPane.showMessageDialog(null,"Oops! No such employee found in database");
            } 
        }
        else{
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/inventorymanager","root","nikhil");
            Statement stmt = con.createStatement();
            int s = stmt.executeUpdate("delete from employees where name='"+a+"';");
            JOptionPane.showMessageDialog(this, "employees Deleted Successfully");
            refresh();
            reorder();
            name.setText("");
        }catch(SQLException se){
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        if(!(a.equals("")||b.equals("")||c.equals("")||d.equals(""))){  
            try{
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost/inventorymanager","root","nikhil");
                Statement st = con.createStatement();
                st.executeUpdate("update employee set name='"+a+"', employeeid='"+b+"', category='"+c+"', number='"+d+"' where name ='"+n1+"';");
